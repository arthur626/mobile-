...
public class FinalizarAdicionarAtividade extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_finalizar_adicionar_atividade);
        ...
        File imgFile = new File("/sdcard/PicturesHELPER/" + os_id + "_" + checklist_id + "_" + id_Atividade + "_" + "4D" + ".jpg");
        File imgFile2 = new File("/sdcard/PicturesHELPER/" + os_id + "_" + checklist_id + "_" + id_Atividade + "_" + "5D" + ".jpg");
        File imgFile3 = new File("/sdcard/PicturesHELPER/" + os_id + "_" + checklist_id + "_" + id_Atividade + "_" + "6D" + ".jpg");
        ...
        txtObservacao.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                new AlertDialog.Builder(FinalizarAdicionarAtividade.this)
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_confirmar) {
            ...
            //Se for uma visita corretiva ele irá direto para Assinatura
                ...
                Intent intent = new Intent(FinalizarAdicionarAtividade.this, TelaAssinaturaTecnico.class);
                ...
                Intent intent = new Intent(FinalizarAdicionarAtividade.this, TelaAtividades.class);
                Bundle dados = new Bundle();
                dados.putString("os_id", os_id);
        ...
        if(id == android.R.id.home) {
            ...
            Intent intent = new Intent(FinalizarAdicionarAtividade.this, Atividade_Antes.class);
            Bundle dados = new Bundle();
            dados.putString("os_id", os_id);
            dados.putString("checklist_id", checklist_id);
            dados.putString("equipamento_id", equipamento_id);
            ...
            switch (requestCode) {
                case 1:
                    ...
                    myDb.updateFotoCaminho1d(
                            ...
                            checklist_id,
                            id_Atividade,
                            "/assets/os/" + os_id + "_" + checklist_id + "_" + id_Atividade + "_" + "4D" + ".jpg");
                    ...
                    myDir.mkdirs();
                    String fname = os_id + "_" + checklist_id + "_" + id_Atividade + "_" + "4D" + ".jpg";
                ...
                case 2:
                    ...
                    myDb.updateFotoCaminho2d(
                            ...
                            checklist_id,
                            id_Atividade,
                            "/assets/os/" + os_id + "_" + checklist_id + "_" + id_Atividade + "_" + "5D" + ".jpg");
                    ByteArrayOutputStream bytes2 = new ByteArrayOutputStream();
                    thumbnail2.compress(Bitmap.CompressFormat.JPEG, 85, bytes2);
                    String imageFileName2 = os_id + "_" + checklist_id + "_" + id_Atividade + "_" + "5D" + ".jpg";
                ...
                case 3:
                    ...
                    myDb.updateFotoCaminho3d(
                            ...
                            checklist_id,
                            id_Atividade,
                            "/assets/os/" + os_id + "_" + checklist_id + "_" + id_Atividade + "_" + "6D" + ".jpg");
                    ByteArrayOutputStream bytes3 = new ByteArrayOutputStream();
                    thumbnail3.compress(Bitmap.CompressFormat.JPEG, 85, bytes3);
                    String imageFileName3 = os_id + "_" + checklist_id + "_" + id_Atividade + "_" + "6D" + ".jpg";
