...
public class VisitaAdapter extends RecyclerView.Adapter<VisitaAdapter.GroceryViewHolder> {
    ...
    public class GroceryViewHolder extends RecyclerView.ViewHolder {
        ...
        public GroceryViewHolder(View itemView) {
            ...
            codigocliente = itemView.findViewById(R.id.codigoclienteos);
    ...
    public void onBindViewHolder(VisitaAdapter.GroceryViewHolder holder, int position) {
        ...
        String codigocliente = mCursor.getString(mCursor.getColumnIndex(BancoGeral.COL_CODIGOCHAMADO_OS));
        ...
        holder.codigocliente.setText("Codigo Cliente: " + codigocliente);
        ...
        while (dataLocal.moveToNext()) {
            ...
            while (dataColaborador.moveToNext()) {
                ...
                //Se pressionar para excluir a OS do telefone
                holder.itemView.setOnLongClickListener(new View.OnLongClickListener() {
                    ...
                    public boolean onLongClick(View v) {
                        ...
                        alertDialog.setTitle("Visita: " + id);
                        alertDialog.setMessage("Você deseja: ");
                        alertDialog.setButton(AlertDialog.BUTTON_POSITIVE, "Excluir Visita do Telefone",
                                new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialog, int which) {

                                        myBDGeral.deleteOS(id);
                                        myBDOperacao.deleteOS(id);
                                    }
                                });
                        alertDialog.setButton(AlertDialog.BUTTON_NEGATIVE, "Fechar Tela",
                                new DialogInterface.OnClickListener() {
                                    @Override
                  ...
                  //  Button btnUltimaVisita = view.findViewById(R.id.btnUltimaVisita);
                    ...
                    acceptButton.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ...
                            Intent intent = new Intent(mContext, TelaAtividades.class);
