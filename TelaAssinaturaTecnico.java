...
import br.com.aaemobile.aaemobile.ViewModel.VisitasEquipamento;
import br.com.aaemobile.aaemobile.banco.BancoGeral;
import br.com.aaemobile.aaemobile.banco.DatabaseHelper;


public class TelaAssinaturaTecnico extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_confirmar) {
            ...
            if (addJpgSignatureToGallery(signatureBitmap)) {
                ...
                Intent intent = new Intent(TelaAssinaturaTecnico.this, TelaAssinaturaCliente.class);
        ...
        if(id == android.R.id.home) {
            ...
            Intent intent = new Intent(TelaAssinaturaTecnico.this, TelaAtividades.class);
            Bundle dados = new Bundle();
            dados.putString("os_id", os_id);
        ...
        switch (requestCode) {
            case REQUEST_EXTERNAL_STORAGE: {
                ...
                if (grantResults.length <= 0
                    ...
                    Toast.makeText(TelaAssinaturaTecnico.this,  "Não foi possivel salvar Assinatura no celular", Toast.LENGTH_SHORT).show();
                }
            }
        }
    }
    ...
    private void scanMediaFile(File photo) {
        ...
        TelaAssinaturaTecnico.this.sendBroadcast(mediaScanIntent);
    }
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Sim", new DialogInterface.OnClickListener()
                {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        myDB.deleteOS(os_id);
                        Intent intent = new Intent(TelaAssinaturaTecnico.this, VisitasEquipamento.class);
                        Bundle dados = new Bundle();
                        dados.putString("equipamento_id", equipamento_id);
                        intent.putExtras(dados);
                        startActivity(intent);
