...
import br.com.aaemobile.aaemobile.Visitas.FinalizarAdicionarAtividade;
import br.com.aaemobile.aaemobile.banco.BancoGeral;
import br.com.aaemobile.aaemobile.banco.DatabaseHelper;


public class AdicionarAtividade extends AppCompatActivity implements  GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {

    DatabaseHelper myDb;
    BancoGeral myDBGeral;
    ImageView imageView, imageView2, imageView3;
    TextView txtLatitude, txtLongitude, txtObservacao;
    ...
    public Spinner spinner_atividades;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checklist_id = dados.getString("checklist");
        ...
        //Popula os spinners
        List<String> atividades = myDBGeral.buscaAtividadesSpinner(checklist_id);
        ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(this,R.layout.spinner_item, atividades);
        dataAdapter.setDropDownViewResource(R.layout.support_simple_spinner_dropdown_item);
        spinner_atividades.setAdapter(dataAdapter);

        //Pega o ID da Atividade
        Cursor dataAtividade = myDBGeral.buscaAtividadeID(spinner_atividades.getSelectedItem().toString(), checklist_id);
        if (dataAtividade.moveToNext()) {

            id_Atividade = dataAtividade.getString(0);
            atividade = dataAtividade.getString(2);
        ...
        txtObservacao.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                new AlertDialog.Builder(AdicionarAtividade.this)
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_confirmar) {
            if (imageView.getDrawable() == null) {
                ...
                Intent intent = new Intent(AdicionarAtividade.this, FinalizarAdicionarAtividade.class);
                Bundle dados = new Bundle();
                dados.putString("os_id", os_id);
                dados.putString("checklist_id", checklist_id);
                dados.putString("equipamento_id", equipamento_id);
                dados.putString("atividade", spinner_atividades.getSelectedItem().toString());
            ...
            Toast.makeText(getApplicationContext(), "Você não pode clicar não se aplica, sendo que está criando uma nova atividade", Toast.LENGTH_LONG).show();
            return true;
        }
        ...
        if (id == android.R.id.home) {
            //Volta para TelaAtividades

            Intent intent = new Intent(AdicionarAtividade.this, TelaAtividades.class);
            Bundle dados = new Bundle();
            dados.putString("os_id", os_id);
            dados.putString("checklist_id", checklist_id);
            dados.putString("equipamento_id", equipamento_id);
        ...
        switch (requestCode) {
            case CAMERA_PIC_REQUEST: {
                ...
                if (grantResults.length <= 0
                    ...
                    Toast.makeText(AdicionarAtividade.this, "Não foi possivel salvar foto", Toast.LENGTH_SHORT).show();
            ...
            switch (requestCode) {
                case 1:
                    ...
                    // Se salvar a 1ª Foto e gravar na tabela
                        ...
                        myDir.mkdirs();
                        String fname = os_id + "_" + checklist_id + "_" + id_Atividade + "_" + "4A" + ".jpg";
                ...
                case 2:
                    ...
                    myDb.updateFotoCaminho2a(
                            ...
                            checklist_id,
                            id_Atividade,
                            "/assets/os/" + os_id + "_" + checklist_id + "_" + id_Atividade + "_" + "5A" + ".jpg");
                    ByteArrayOutputStream bytes2 = new ByteArrayOutputStream();
                    thumbnail2.compress(Bitmap.CompressFormat.JPEG, 85, bytes2);
                    String imageFileName2 = os_id + "_" + checklist_id + "_" + id_Atividade + "_" + "5A" + ".jpg";
                ...
                case 3:
                    ...
                    myDb.updateFotoCaminho3a(
                            ...
                            checklist_id,
                            id_Atividade,
                            "/assets/os/" + os_id + "_" + checklist_id + "_" + id_Atividade + "_" + "6A" + ".jpg");
                    ByteArrayOutputStream bytes3 = new ByteArrayOutputStream();
                    thumbnail3.compress(Bitmap.CompressFormat.JPEG, 85, bytes3);
                    String imageFileName3 = os_id + "_" + checklist_id + "_" + id_Atividade + "_" + "6A" + ".jpg";
    ...
    private synchronized void callConection() {
        mGoogleApiClient = new GoogleApiClient.Builder(AdicionarAtividade.this)
                .addOnConnectionFailedListener(AdicionarAtividade.this)
                .addConnectionCallbacks(AdicionarAtividade.this)
    ...
    public void onConnected(@Nullable Bundle bundle) {
        ...
        if (ContextCompat.checkSelfPermission(AdicionarAtividade.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED)
            ActivityCompat.requestPermissions(AdicionarAtividade.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, REQUEST_LOCATION);
