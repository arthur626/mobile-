package br.com.aaemobile.aaemobile.banco;
...
public class BancoGeral extends SQLiteOpenHelper {
    public static final String DATABASE_NAME = "aplusnet300.db";
    ...
    public static final String COL_ORDEMSERVICO_ITEN = "ordemservico_id";
    ...
    public Cursor buscaLocaisEstacoes(String local_id) {
        SQLiteDatabase db = this.getWritableDatabase();
        String query = "SELECT * FROM " + TABELA_LOCAL +
                " WHERE " + COL_ID_LOCAL + " = '" + local_id + "'";
        Cursor data = db.rawQuery(query, null);
        return data;
    }
    ...
    public int dbCountEncerradasLocalID(String local_id) {
        int count = 0;
        String selectQuery = "SELECT  * FROM " + TABELA_OS + " WHERE " + COL_STATUS_OS + " = '" + "encerrada" + "' AND " + COL_LOCAL_OS + " = '" + local_id + "'";
        SQLiteDatabase database = this.getWritableDatabase();
        Cursor cursor = database.rawQuery(selectQuery, null);
        count = cursor.getCount();
        Log.d("query", selectQuery);
    ...
    public int dbCountAbertasLocalID(String local_id) {
        int count = 0;
        String selectQuery = "SELECT  * FROM " + TABELA_OS + " WHERE " + COL_STATUS_OS + " = '" + "aberta" + "' AND " + COL_LOCAL_OS + " = '" + local_id + "'";
        SQLiteDatabase database = this.getWritableDatabase();
        Cursor cursor = database.rawQuery(selectQuery, null);
        count = cursor.getCount();
        Log.d("query", selectQuery);
    ...
    public int dbCountEmEsperaLocalID(String local_id) {
        int count = 0;
        String selectQuery = "SELECT  * FROM " + TABELA_OS + " WHERE " + COL_STATUS_OS + " = '" + "em espera" + "' AND " + COL_LOCAL_OS + " = '" + local_id + "'";
        SQLiteDatabase database = this.getWritableDatabase();
        Cursor cursor = database.rawQuery(selectQuery, null);
        count = cursor.getCount();
        Log.d("query", selectQuery);
    ...
    public Cursor buscaAtividadeParaRealizar(String checklist_id) {
            SQLiteDatabase db = this.getWritableDatabase();
        String query = "SELECT * FROM " + TABELA_ATIVIDADES +
                " WHERE " + COL_STATUS_ITEN + " != '" + "encerrada" + "' AND " + COL_CHECKLIST_ITEN + " = '" + checklist_id + "'";
        Cursor data = db.rawQuery(query, null);
        return data;
    }
    ...
    public void updateStatusAtividade(String checklist_id, String idAtividade, String status) {
        SQLiteDatabase database = this.getWritableDatabase();
        String updateQuery = "Update " + TABELA_ATIVIDADES + " set status = '" + status + "' where " + COL_ID_ITEN + " =" + "'" + idAtividade + "' AND " + COL_CHECKLIST_ITEN + " = '" + checklist_id + "'";
        Log.d("query", updateQuery);
        database.execSQL(updateQuery);
    }
    ...
    public Cursor buscaOSLocal(String local_id, String colaborador_id) {
        SQLiteDatabase db = this.getWritableDatabase();
        String query = "SELECT * FROM " + TABELA_OS +
                " WHERE " + COL_LOCAL_OS + " = '" + local_id + "' AND " + COL_STATUS_OS + " = '" + "aberta" + "' AND " + COL_EQUIPE1_OS + " = '" + colaborador_id + "'";
        Cursor data = db.rawQuery(query, null);
        Log.d("query", query);
        return data;
    }

    public Cursor buscaOSLocalMapa(String local_id) {
        SQLiteDatabase db = this.getWritableDatabase();
        String query = "SELECT * FROM " + TABELA_OS +
                " WHERE " + COL_LOCAL_OS + " = '" + local_id  + "'";
        Cursor data = db.rawQuery(query, null);
    ...
    public Cursor buscaAtividadesAbertas(String checklist_id) {
        SQLiteDatabase db = this.getWritableDatabase();
        String query = "SELECT * FROM " + TABELA_ATIVIDADES +
                " WHERE " + COL_CHECKLIST_ITEN + " = '" + checklist_id + "'" + " AND " + COL_STATUS_ITEN + " != '" + "encerrada" + "'";
        Cursor data = db.rawQuery(query, null);
        return data;
    }
    ...
    public int dbCountAtividadesAbertas(String checklist_id) {
        int count = 0;
        String selectQuery = "SELECT * FROM " + TABELA_ATIVIDADES + " WHERE " + COL_CHECKLIST_ITEN + " = '" + checklist_id + "' AND " + COL_STATUS_ITEN + " != '" + "encerrada" + "'";
        SQLiteDatabase database = this.getWritableDatabase();
        Cursor cursor = database.rawQuery(selectQuery, null);
        count = cursor.getCount();
        return count;
    ...
    public Cursor filtroOSData(String search, String local_id){
        SQLiteDatabase db = this.getReadableDatabase();
        String query = "SELECT * FROM " + TABELA_OS +
                " WHERE " + " ( " + COL_DATAPLANEJAMENTO_OS  + " LIKE  '%" +search + "%'" + ") " +  " AND " + COL_STATUS_OS + " = '" + "aberta" + "'" + " AND " + COL_LOCAL_OS + "='" +  local_id + "'";
        Cursor cursor = db.rawQuery(query, null);
        Log.d("query", query);
        // looping through all rows and adding to list
        if (cursor == null) {
    ...
    public Cursor buscaOSMes(String search){
        SQLiteDatabase db = this.getReadableDatabase();
        String query = "SELECT * FROM " + TABELA_OS +
                " WHERE " + " ( " + COL_DATAPLANEJAMENTO_OS  + " LIKE  '%" +search + "%'" + ")";
        Cursor cursor = db.rawQuery(query, null);
        Log.d("query", query);
        // looping through all rows and adding to list
        if (cursor == null) {
    ...
    public Cursor filtroOSEquipamentoData(String search, String equipamento_id){
        SQLiteDatabase db = this.getReadableDatabase();
        String query = "SELECT * FROM " + TABELA_OS +
                " WHERE " + " ( " + COL_DATAPLANEJAMENTO_OS  + " LIKE  '%" +search + "%'" + ") " +  " AND " + COL_STATUS_OS + " = '" + "aberta" + "'" + " AND " + COL_EQUIPAMENTO_OS + "='" +  equipamento_id + "'";
        Cursor cursor = db.rawQuery(query, null);
        Log.d("query", query);
        // looping through all rows and adding to list
        if (cursor == null) {
    ...
    public Cursor buscaVisitasAbertasLocal(String search, String local_id){
        SQLiteDatabase db = this.getReadableDatabase();
        String query = "SELECT * FROM " + TABELA_OS +
                " WHERE "  + COL_STATUS_OS + " = '" + search + "' AND " + COL_LOCAL_OS + " = '" + local_id + "'";
        Cursor cursor = db.rawQuery(query, null);
        // looping through all rows and adding to list
        if (cursor == null) {
            return null;
    ...
    public Cursor buscaVisitasAbertasEquipamento(String search, String equipamento_id){
        SQLiteDatabase db = this.getReadableDatabase();
        String query = "SELECT * FROM " + TABELA_OS +
                " WHERE "  + COL_STATUS_OS + " = '" + search + "' AND " + COL_EQUIPAMENTO_OS + " = '" + equipamento_id + "'";
        Cursor cursor = db.rawQuery(query, null);
        // looping through all rows and adding to list
        if (cursor == null) {
            return null;
    ...
    public Cursor buscaVisitasEmEsperaLocal(String search, String local_id){
        SQLiteDatabase db = this.getReadableDatabase();
        String query = "SELECT * FROM " + TABELA_OS +
                " WHERE "  + COL_STATUS_OS + " = '" + search + "' AND " + COL_LOCAL_OS + " = '" + local_id + "'";
        Cursor cursor = db.rawQuery(query, null);
    ...
    public Cursor buscaVisitasEmEsperaEquipamento(String search, String equipamento_id){
        SQLiteDatabase db = this.getReadableDatabase();
        String query = "SELECT * FROM " + TABELA_OS +
                " WHERE "  + COL_STATUS_OS + " = '" + search + "' AND " + COL_EQUIPAMENTO_OS + " = '" + equipamento_id + "'";
        Cursor cursor = db.rawQuery(query, null);
    ...
    public Cursor buscaVisitasEncerradasLocal(String search, String local_id){
        SQLiteDatabase db = this.getReadableDatabase();
        String query = "SELECT * FROM " + TABELA_OS +
                " WHERE "  + COL_STATUS_OS + " = '" + search + "' AND " + COL_LOCAL_OS + " = '" + local_id + "'";
        Cursor cursor = db.rawQuery(query, null);
    ...
    public Cursor filtroOS(String search, String colaborador_id){
        SQLiteDatabase db = this.getReadableDatabase();
        String query = "SELECT * FROM " + TABELA_OS +
                " WHERE " + " ( " + COL_ID_OS  + " LIKE  '%" +search + "%'" + " OR " + COL_DATAPLANEJAMENTO_OS  +  "  LIKE  '%" +search + "%'"  + " OR " + COL_FREQUENCIA_DESCRICAO  + "  LIKE  '%" +search + "%'"  + " OR " + COL_TIPOSERVICO_OS  + "  LIKE  '%" +search + "%'"  + ") " +  " AND " + COL_EQUIPE1_OS + " = '" + colaborador_id +  "'";
        Cursor cursor = db.rawQuery(query, null);
        // looping through all rows and adding to list
    ...
    public void updateOS(String id, String local_id, String centrocusto_idOS, String tiposervico_id, String tiposervico_descricao, String frequencia_id, String frequencia_descricao, String equipamento_id, String checklist_id, String equipe1, String dataplanejamento, String descricaopadrao, String flag_os, String codigochamado){
        SQLiteDatabase database = this.getWritableDatabase();
        String updateQuery = "Update " + TABELA_OS + " set local_id= '" + local_id + "', centrocusto_idOS= '" + centrocusto_idOS + "',    equipamento_id = '"+ equipamento_id + "', checklist_id = '" + checklist_id + "', equipe1= '"+ equipe1  +"', dataplanejamento = '" + dataplanejamento + "', descricaopadrao = '"+ descricaopadrao  + "', tiposervico_id = '"+ tiposervico_id  + "', tiposervico_descricao = '"+ tiposervico_descricao +  "',  frequencia_id = '"+ frequencia_id  + "', frequencia_descricao = '"+ frequencia_descricao +  "',flag_os = '"+ flag_os + "', codigochamado = '"+ codigochamado +"' where id="+"'"+ id +"'";
        Log.d("query",updateQuery);
        database.execSQL(updateQuery);
    }
    ...
    {
        SQLiteDatabase db = this.getWritableDatabase();
        db.execSQL("DELETE FROM " + TABELA_OS + " WHERE "+ COL_ID_OS +"='"+ value+ "'");
        db.close();
    }
