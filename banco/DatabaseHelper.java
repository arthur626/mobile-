...
public class DatabaseHelper extends SQLiteOpenHelper {
    public static final String DATABASE_NAME = "aplusnet254.db";
    ...
    public void updateAtividade(String os,
                                String checklist_id,
                                String checklistitens_id,
        ...
        String updateQuery = "Update " + TABLE_NAME + " set observacaoantes = '" + observacaoantes + "'," +
                "latitude = '" + latitude  + "', " +
                "longitude = '" + longitude +"', " +
                "situacao = '" + situacao +"', " +
                "update_Status = '" + update_Status +"' " +
                "where ordemservico_id ="+"'"+ os + "'" +
                " AND " + COL_3
                + " = '" + checklistitens_id +
                "'";
    ...
    public boolean iniciaAtividade(String ordemservico,
                                   String checklist_id,
                                   String checklistitens_id,
                                   String inicio,
                                   String updateStatus) {
    ...
    public ArrayList<HashMap<String, String>> getAllUsers() {
        ...
        String selectQuery = "SELECT  * FROM  " + TABLE_NAME + " ORDER BY " + COL_3 + " ASC";
        SQLiteDatabase database = this.getWritableDatabase();
    ...
    public String composeJSONfromSQLite(){
        ArrayList<HashMap<String, String>> wordList;
        wordList = new ArrayList<HashMap<String, String>>();
        String selectQuery = "SELECT  * FROM " + TABLE_NAME  +" where update_Status = '"+"no" + "' ORDER BY " + COL_3 + " ASC";
        SQLiteDatabase database = this.getWritableDatabase();
        Cursor cursor = database.rawQuery(selectQuery, null);
        if (cursor.moveToFirst()) {
            do {
     ...
     * @param foto;
     */
    public void updateFotoCaminho1a(String os, String checklist_id, String checklistitens_id, String foto){
        SQLiteDatabase database = this.getWritableDatabase();
        String updateQuery = "Update " + TABLE_NAME + " set foto1a = '" + foto  +"' where " + COL_1 + " = "+"'"+ os + "'" + " AND "+ COL_2 +"='"+ checklist_id + "'" + " AND "+ COL_3 +"='"+ checklistitens_id + "'";
        Log.d("query",updateQuery);
        database.execSQL(updateQuery);
        database.close();
    }
    ...
    public void updateFotoCaminho3a(String os, String checklist_id, String checklistitens_id, String foto){
        SQLiteDatabase database = this.getWritableDatabase();
        String updateQuery = "Update " + TABLE_NAME + " set foto3a = '" + foto  +"' where " + COL_1 + " = "+"'"+ os + "'" + " AND "+ COL_2 +"='"+ checklist_id + "'" + " AND "+ COL_3 +"='"+ checklistitens_id + "'";
        Log.d("query",updateQuery);
        database.execSQL(updateQuery);
        database.close();
    }
    ...
    public void updateFotoCaminho1d(String os, String checklist_id, String checklistitens_id, String foto){
        SQLiteDatabase database = this.getWritableDatabase();
        String updateQuery = "Update " + TABLE_NAME + " set foto1d = '" + foto  +"' where " + COL_1 + " = "+"'"+ os + "'" + " AND "+ COL_2 +"='"+ checklist_id + "'" + " AND "+ COL_3 +"='"+ checklistitens_id + "'";
        Log.d("query",updateQuery);
        database.execSQL(updateQuery);
        database.close();
    }
    ...
    public void updateFotoCaminho2d(String os, String checklist_id, String checklistitens_id, String foto){
        SQLiteDatabase database = this.getWritableDatabase();
        String updateQuery = "Update " + TABLE_NAME + " set foto2d = '" + foto  +"' where " + COL_1 + " = "+"'"+ os + "'" + " AND "+ COL_2 +"='"+ checklist_id + "'" + " AND "+ COL_3 +"='"+ checklistitens_id + "'";
        Log.d("query",updateQuery);
        database.execSQL(updateQuery);
        database.close();
    }
    ...
    public void updateFotoCaminho3d(String os, String checklist_id, String checklistitens_id, String foto){
        SQLiteDatabase database = this.getWritableDatabase();
        String updateQuery = "Update " + TABLE_NAME + " set foto3d = '" + foto  +"' where " + COL_1 + " = "+"'"+ os + "'" + " AND "+ COL_2 +"='"+ checklist_id + "'" + " AND "+ COL_3 +"='"+ checklistitens_id + "'";
        Log.d("query",updateQuery);
        database.execSQL(updateQuery);
        database.close();
    }
    ...
    public void updateNA(String ordemservico_id, String checklist_id, String checklistitens_id, String foto1a, String foto2a, String foto3a, String foto1d, String foto2d, String foto3d, String fim, String observacaoantes, String observacaodepois, String latitude, String longitude, String situacao, String dataencerramento, String update_Status ) {
        SQLiteDatabase database = this.getWritableDatabase();

        String updateQuery = "Update " + TABLE_NAME + " set " +
                " ordemservico_id = '" + ordemservico_id + "'," +
                " checklist_id = '" + checklist_id + "'," +
                " checklistitens_id = '" + checklistitens_id + "'," +
                " foto1a = '" + foto1a + "'," +
                " foto2a = '" + foto2a + "'," +
                " foto3a = '" + foto3a + "'," +
                " foto1d = '" + foto1d + "'," +
                ...
                " foto3d = '" + foto3d + "'," +
                " fim = '" + fim + "'," +
                " observacaoantes = '" + observacaoantes + "'," +
                " observacaodepois = '" + observacaodepois + "'," +
                " latitude = '" + latitude + "'," +
                " longitude = '" + longitude + "'," +
                " latitude = '" + latitude + "'," +
                " latitude = '" + latitude + "'," +
                ...
                " update_Status = '" + update_Status + "' " +
                "WHERE ordemservico_id =" + "'" + ordemservico_id + "'" + " AND "+ COL_2 +"='"+ checklist_id + "'" + " AND "+ COL_3 +"='"+ checklistitens_id + "'";
    ...
    public Cursor verificaAtividade(String ordemservico, String checklist, String idAtividade){
        SQLiteDatabase db = this.getWritableDatabase();
        String query = "SELECT * FROM " + TABLE_NAME +
                " WHERE " + COL_1 + " = '" + ordemservico + "'" + " AND "+ COL_2 +"='"+ checklist + "'" + " AND "+ COL_3 +"='"+ idAtividade + "'";
        Cursor data = db.rawQuery(query, null);
        return data;
    }

    public Cursor buscaAtividadePendente(String idAtividade, String ordemservico_id){
        SQLiteDatabase db = this.getWritableDatabase();
        String query = "SELECT * FROM " + TABLE_NAME +
                " WHERE " + COL_3 + " = '" + idAtividade + "'" + " AND "+ COL_1 +"='"+ ordemservico_id + "'";
        Cursor data = db.rawQuery(query, null);
        return data;
    }

    public Cursor buscaAtividadeEncerrada(String idAtividade, String ordemservico_id){
        SQLiteDatabase db = this.getWritableDatabase();
        String query = "SELECT * FROM " + TABLE_NAME +
                " WHERE " + COL_3 + " = '" + idAtividade + "'" + " AND "+ COL_1 +"='"+ ordemservico_id + "'";
        Cursor data = db.rawQuery(query, null);
