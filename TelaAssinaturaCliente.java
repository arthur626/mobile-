...
public class TelaAssinaturaCliente extends AppCompatActivity {
        ...
        alert.setNeutralButton("Não se Aplica", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                if (frequencia_idINT == 1) {
                    ...
                    Intent intent = new Intent(TelaAssinaturaCliente.this, TelaPrincipal.class);
                ...
                //Se for NA (Provavelmente sem periodicidade)
                    ...
                    //Irá perguntar se ele deseja ver como ficou o Relatorio, caso ele não queira ver irá finalizar normalmente

                    //   AlertDialog alertDialog = new AlertDialog.Builder(TelaAssinaturaCliente.this).create();
                    //   alertDialog.setTitle("AAE MOBILE");
                    //    alertDialog.setMessage("Deseja vizualizar o relatório fotográfico da OS: " + os_id);
                    //    alertDialog.setIcon(R.drawable.ic_mostrarpdf);

                    //  alertDialog.setButton(AlertDialog.BUTTON_POSITIVE, "SIM", new DialogInterface.OnClickListener() {
                    //      public void onClick(DialogInterface dialog, int which) {

                    //       Intent intent = new Intent(TelaAssinaturaCliente.this, RelatorioVisita.class);
                    //       Bundle dados = new Bundle();
                    //       dados.putString("os_id", os_id);
                    //       dados.putString("checklist_id", checklist);
                    //       dados.putString("local_id", local_id);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        Date dt = new Date();
        SimpleDateFormat sdfBR = new SimpleDateFormat("HH:mm:ss - dd/MM/yyyy");
        ...
        if (id == R.id.action_confirmar) {
            ...
            if (addJpgSignatureToGallery(signatureBitmap)) {
                ...
                //Fim IF
                    ...
                    Toast.makeText(TelaAssinaturaCliente.this,  "Não foi possivel salvar assinatura !", Toast.LENGTH_SHORT).show();
                }
        ...
        switch (requestCode) {
            case REQUEST_EXTERNAL_STORAGE: {
                ...
                if (grantResults.length <= 0
                    ...
                    Toast.makeText(TelaAssinaturaCliente.this,  "Não foi possivel salvar Assinatura no celular", Toast.LENGTH_SHORT).show();
                }
            }
        }
    }
    ...
    public boolean addJpgSignatureToGallery(Bitmap signature) {
        ...
        try {
            String root = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES + "HELPER/enviar/")+File.separator;
    ...
    private void scanMediaFile(File photo) {
        ...
        TelaAssinaturaCliente.this.sendBroadcast(mediaScanIntent);
    }
